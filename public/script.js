document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    var isRequired = field.hasAttribute('required') || field.dataset.required === 'true';
  ...
  function checkAnimations() {
    animatedElements.forEach(function (el) {
      if (el.classList.contains('scroll-animate-pending') && isElementInViewport(el)) {
  ...
  var scrollAnimationStyle = document.createElement('style');
  scrollAnimationStyle.textContent = [
    '.scroll-animate-pending {',
    '  opacity: 0;',
    '  transform: translateY(24px);',
    '  transition: opacity 0.6s ease, transform 0.6s ease;',
    '}',
    '.fade-left.scroll-animate-pending {',
    '  transform: translateX(24px);',
    '}',
    '.fade-right.scroll-animate-pending {',
    '  transform: translateX(-24px);',
    '}',
    '.fade-down.scroll-animate-pending {',
    '  transform: translateY(-24px);',
    '}',
    ...
    var intersectionObserver = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          var delayMs = parseFloat(delay) * (delay.indexOf('ms') !== -1 ? 1 : 1000);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4afbe36d-1f9f-4627-bf9c-7f9a66a9b187',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4afbe36d-1f9f-4627-bf9c-7f9a66a9b187';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4afbe36d-1f9f-4627-bf9c-7f9a66a9b187';
